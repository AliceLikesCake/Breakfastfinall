function initializejQueryFunctions(memberId) {
    $(document).ready(function () {
        ...
        function getPointsClass(points, type) {
            if (type === 'earned') {
                return '<span class="earned-points">' + points + ' 點</span>';
            } else if (type === 'used') {
                return '<span class="used-points">' + points + ' 點</span>';
            } else {
                return '<span class="points">' + points + ' 點</span>';
            }
        }
